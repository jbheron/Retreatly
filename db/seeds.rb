...
User.all.each do |user|
	...
	5.times do
		...
		event = Event.create(title: "Yoga retreat in #{city}", description: Faker::Company.catch_phrase, start_date: startdate, end_date: enddate, price: rand(1000..10000), user_id: user.id)
